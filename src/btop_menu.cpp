  ...
  std::unordered_map<string, Input::Mouse_loc> mouse_mappings;
   ...
   const array<array<string, 3>, 3> menu_normal = {
	...
	const vector<vector<vector<string>>> categories = {
		...
		#ifdef __linux__
			{"show_sensors",
				"Show hwmon temperature sensors box.",
				"",
				"Displays additional temperature sensors",
				"from /sys/class/hwmon and /sys/class/thermal",
				"that are not used for CPU/GPU monitoring.",
				"",
				"Use \"sensors_filter\" to select which",
				"sensors to show."},
			{"sensors_filter",
				"Filter for sensors box.",
				"",
				"Comma-separated list of hwmon driver",
				"names to show (e.g. \"nvme,it8613\").",
				"",
